...
# 🚀  DoH پیشرفته با پنل مدیریت کانفیگ 
...
این پروژه یک  DoH (DNS over HTTPS) است که بر روی  کلادفلر اجرا می‌شود. این سرویس درخواست‌های DNS شما را برای افزایش حریم خصوصی و امنیت رمزنگاری می‌کند.
